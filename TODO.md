...
2. PR1 – 見出し収集（イベントベース・スラグなし）
   ...
   - まずはレベル 1 見出しの `{ depth, text }` のみを `headings` に収集する（スラグ付与は PR2 以降）。

3. PR2 – ASCII スラグ化（衝突処理付き）
...
4. PR3 – Unicode / CJK スラグ化とドキュメント整備
